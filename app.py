...
def main():
    ...
    if prompt := st.chat_input("Welcome! I'm here to help you manage anxiety and provide support. What's on your mind?"):
        ...
        with st.chat_message("user", avatar=st.image("https://github.com/iisabelaaa/capstone/main/user.png")):
            st.markdown(prompt)
        ...
        try:
            ...
            if topic == "Unknown" or sentiment == "Unknown" or emotion == "Unknown":
                ...
                with st.chat_message("assistant", avatar=st.image("https://github.com/iisabelaaa/capstone/main/assistant.png")):
